        ...
        <div class="box-body">
          <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
              ...
              <form method="post" action="<?php echo base_url().'crud_standar/update' ?>">
                ...
                <div class="form-group">
                  ...
                  <textarea name="alamat" rows="5" class="form-control"><?php echo $row['alamat'] ?></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="tanggal_daftar" class="form-control" value="<?php echo $row['tanggal_daftar'] ?>">
                </div>
